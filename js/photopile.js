...
var photopile = (function() {
  ...
  var thumbBorderWidth  = 4;          // border width (px)
  ...
  var photoBorder       = 7;         // border width around fullsize image
  ...
  var thumb = {
      ...
      setOverlap  : function( thumb ) { thumb.css( 'margin', ((thumbOverlap * -1) / 3) + 'px' ); },
  ...
  var photo = {
      ...
      windowPadding  : 5,     // minimum space between container and edge of window (px)
